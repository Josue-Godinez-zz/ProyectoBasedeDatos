...
GRANT EXECUTE, DEBUG ON prc_asignarroles TO USUARIO_GERENTE;

GRANT EXECUTE, DEBUG ON prc_asignarroles TO USUARIO_COORDINADOR;

GRANT EXECUTE, DEBUG ON prc_asignarroles TO USUARIO_CAJERO;

GRANT EXECUTE, DEBUG ON prc_asignarroles TO USUARIO_ENCARGADO_INVENTARIO;
